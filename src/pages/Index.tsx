...
import { Zap, ArrowRight, Trophy, Users, Target } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background/90 to-background/80">
      ...
      <section className="relative py-16 sm:py-20 lg:py-24 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-3/4 right-1/4 w-96 h-96 bg-gradient-glow opacity-15 rounded-full blur-3xl animate-float" style={{ animationDelay: '1.5s' }}></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full bg-gradient-to-r from-fitness-orange/5 via-transparent to-fitness-orange/5 opacity-30"></div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Training Option */}
            <div className="flex justify-center max-w-4xl mx-auto mb-12 sm:mb-16 lg:mb-20">
              {/* CrossTraining Card */}
            ...
            <div className="animate-fade-in max-w-4xl mx-auto" style={{ animationDelay: '0.7s' }}>
              <div className="text-center mb-12">
                ...
                <p className="text-lg lg:text-xl text-muted-foreground mb-8 leading-relaxed">
                  Únete a nuestra comunidad de atletas y descubre todo tu potencial<br className="hidden sm:block" />
                  con entrenamientos diseñados para maximizar tus resultados.
                </p>
              </div>
              ...
              <div className="flex justify-center max-w-md mx-auto">
                <Button 
                  size="lg"
                  onClick={() => navigate('/crosstraining')}
                  className="w-full bg-gradient-primary hover:opacity-90 transition-all duration-300 py-6 text-base lg:text-lg font-semibold"
                >
              ...
              <div className="mt-12 sm:mt-16 lg:mt-20 grid md:grid-cols-3 gap-6 sm:gap-8 text-center pb-8 sm:pb-12 lg:pb-16">
                <div className="group animate-fade-in" style={{ animationDelay: '0.9s' }}>
                  <div className="w-16 h-16 bg-gradient-to-br from-fitness-orange/20 to-fitness-orange/30 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="group animate-fade-in" style={{ animationDelay: '1.1s' }}>
                  <div className="w-16 h-16 bg-gradient-to-br from-fitness-orange/30 to-fitness-orange/20 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
